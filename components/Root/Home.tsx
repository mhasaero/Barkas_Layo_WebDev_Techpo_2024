...
export default function Home() {
  return (
    <section id="home" className="h-screen">
      <div className="absolute left-0 right-0 top-10 flex h-screen items-center bg-[url('/images/banner.png')] bg-cover bg-fixed md:top-20">
        <div className="mx- flex justify-center md:mr-20 md:justify-end">
          <div className="flex h-fit w-3/4 flex-col justify-between gap-4 rounded-2xl bg-background p-6 md:w-1/2 md:p-8">
